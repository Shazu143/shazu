...
\033[1;96m$$  _____|$$ |      \_$$  _|\__$$  __|$$  _____|
...
\033[1;96m\________|\________|\______|   \__|   \________|                                                                                                                                        

\033[1;96m-------------------------------------------------

\033[1;97m  ➤ Author  : ABDULLAH (\x1b[1;32mMR DADA\x1b[1;37m) 

\033[1;97m  ➤ Github  : https://github.com/AbdullahDada420

\033[1;97m  ➤ Fb ID   : https://facebook.com/D4D4HERE

\033[1;96m-------------------------------------------------

\033[1;97m         [\033[1;97m\033[1;41mTHE UNB34T4BL3 XHOKR4 MR D4D4\033[0m\x1b[1;37m]
...
def menu():
    ...
    print('╠══\x1b[1;96m[A] \x1b[1;97mCrack From Random Number')
    ...
    print('%s╠══[%s4%s] %sGet Target Data'%(O,P,O,P))
...
def tambah_pass():
    ...
    cuy = input('%s╠══[%s•%s] %sEnter the Manual Additional Pass [1 pass] : '%(O,P,O,P))
...
def tambah_pass_angka():
    ...
    coy = input('%s╠══[%s•%s] %sEnter Additional Pass Behind Name[1 pass] : '%(O,P,O,P))
...
class crack:
    ...
    def __init__(self,files):
        ...
        print('%s╠══[%s•%s] %sCrack With Password Auto/Choice [a/c]'%(O,P,O,P))
            ...
            if f=="":
                ...
                try:
                    ...
                    if put in ['']:
                        ...
                        print('%s╠══[%s•%s] %sShow CP Account ? [y/n]'%(O,P,O,P))
            ...
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    try:
                        ...
                        print("\r%s[%sAbdullah-CP%s] %s • %s • %s %s %s%s"%(O,P,O,fl.get("id"),i,d,m,y,tahun(fl.get("id"))))
                    ...
                    print("\r%s[%sAbdullah-CP%s] %s • %s%s     "%(O,P,O,fl.get("id"),i,tahun(fl.get("id"))))
                    ...
                    print("\r%s[%sAbdullah-OK%s] %s • %s%s     "%(H,P,H,fl.get("id"),i,tahun(fl.get("id"))))
            ...
            for i in fl.get("pw"):
                ...
                if log.get("status")=="cp":
                    ...
                    try:
                        ...
                        print("\r%s[%sAbdullah-CP%s] %s • %s • %s %s %s%s"%(O,P,O,fl.get("id"),i,d,m,y,
